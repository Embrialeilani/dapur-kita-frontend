      ...
      <div className="container">
        <section className="hero-own">
          <div className="hero-own-left">
            <h1>
              Temukan Catering <span className="accent">Lezat & Higienis</span> untuk Acaramu
            </h1>
            <p>
              Pesan paket catering untuk pernikahan, kantor, arisan, dan acara spesial lainnya.
            ...
            <div className="hero-search">
              ...
              />
              <Link
                href={searchQuery.trim() ? `/menu?search=${encodeURIComponent(searchQuery.trim())}` : '/menu'}
      ...
      <div className="container">
        <div className="stats-section reveal">
          <div className="stat-card">
            ...
            <div className="stat-number"><span data-count="1250">0</span>+</div>
            <div className="stat-label">Pesanan Selesai</div>
          </div>
          <div className="stat-card">
            <div className="stat-icon">⭐</div>
            <div className="stat-number"><span data-count="98">0</span>%</div>
            <div className="stat-label">Pelanggan Puas</div>
          </div>
          <div className="stat-card">
            <div className="stat-icon">🍱</div>
            <div className="stat-number"><span data-count="50">0</span>+</div>
            <div className="stat-label">Menu Tersedia</div>
          </div>
          <div className="stat-card">
            <div className="stat-icon">🏆</div>
            <div className="stat-number"><span data-count="8">0</span></div>
        ...
        <section className="section" id="tentang">
          ...
          <p className="section-subtitle reveal">Pilih layanan catering sesuai kebutuhan acaramu</p>
          <div className="feat-grid">
            <div className="feat-card reveal">
              <div className="feat-icon">🚚</div>
              <h3>Pengiriman Cepat</h3>
              <p>Pesanan diantar tepat waktu ke lokasi acaramu, tidak pernah terlambat.</p>
              <Link href="/menu" className="btn btn-primary btn-sm">Lihat Paket</Link>
            </div>
            <div className="feat-card reveal reveal-delay-1">
              <div className="feat-icon">🍽️</div>
              <h3>Catering Acara</h3>
              <p>Paket lengkap untuk pernikahan, kantor, arisan, dan acara besar lainnya.</p>
              <Link href="/menu" className="btn btn-primary btn-sm">Lihat Paket</Link>
            </div>
            <div className="feat-card reveal reveal-delay-2">
              <div className="feat-icon">✨</div>
              <h3>Bahan Berkualitas</h3>
              <p>Bahan segar pilihan, diolah higienis dengan standar sanitasi tinggi.</p>
              <Link href="/menu" className="btn btn-primary btn-sm">Lihat Paket</Link>
            </div>
          </div>
        </section>
...
<Portfolio />
        ...
        <section className="section">
          ...
          <p className="section-subtitle reveal">Pengalaman pelanggan menggunakan layanan Dapur Kita</p>
          <div className="testimonials-grid">
            <div className="testimonial-card reveal-left">
              <div className="testimonial-avatar">B</div>
              <p className="testimonial-text">"Makanan sangat enak dan tepat waktu. Pelayanannya ramah."</p>
              <div className="testimonial-name">Budi Santoso</div>
              <div className="testimonial-event">Acara Syukuran Kantor</div>
            </div>
            <div className="testimonial-card reveal">
              <div className="testimonial-avatar">R</div>
              <p className="testimonial-text">"Rasanya juara! Tamu acara saya pada minta nambah."</p>
            ...
            <div className="testimonial-card reveal-right">
              ...
              <p className="testimonial-text">"Admin gercep, harga oke. Recommended buat acara apapun."</p>
        ...
        <section className="section" id="lokasi">
          ...
          <p className="section-subtitle reveal">Kunjungi dapur kami atau hubungi untuk konsultasi acara</p>
      ...
      <a href={waLink} target="_blank" rel="noopener noreferrer" className="wa-float" title="Chat WhatsApp">💬</a>
    </>
  );
}